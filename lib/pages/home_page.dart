...
import 'package:projectssrk/pages/audio_quiz.dart';
                          ...
                          Row(
                            children: [
                              QuizTypeButton(
                                ...
                                quizType: 'counting',
                                buttonImage:
                                    'lib/images/counting_button_img.png',
                              ),
                              QuizTypeButton(
                                button_color:
                                    Color.fromARGB(255, 255, 213, 231),
                                button_text: "Coloring",
                                questions: questions_color,
                                quizType: 'coloring',
                                buttonImage:
                                    'lib/images/coloring_button_img.png',
                              ),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                height: 150,
                                decoration: BoxDecoration(
                                  color: Color.fromARGB(255, 218, 230, 126),
                                ...
                                child: TextButton(
                                  onPressed: () async {
                                    // Navigate to AudioQuiz
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) => AudioQuiz()),
                                    );
                                  },
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
